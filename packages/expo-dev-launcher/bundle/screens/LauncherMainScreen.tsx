...
import { getRecentlyOpenedApps } from '../DevLauncherInternal';
...
import { isDevMenuAvailable, getDevSessions } from './../DevMenu';
...
class LauncherMainScreen extends React.Component<Props, State> {
  ...
  componentDidMount() {
    getRecentlyOpenedApps().then(openedProjects => {
  ...
  private renderCamera() {
    return Platform.select({
      ios: <Text>Open your camera app and scan the QR generated by expo start</Text>,
      android: (
        <View>
